...
bool ProcessBlockFound(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != chainActive.Tip()->GetBlockHash())
            return error("LadacoinMiner : generated block is stale");
    }
    ...
    if (!ProcessNewBlock(state, NULL, pblock))
        return error("LadacoinMiner : ProcessNewBlock, block not accepted");
...
{
    LogPrintf("LadacoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("ladacoin-miner");
    ...
    try {
        while (true) {
			...
			if (chainActive.Height() > nHeightMax) {
				LogPrintf("Timeout in LadacoinMiner : Time: %s is not now for over hight limit active block (%s)! wait 2.5 min...\n", GetAdjustedTime(), chainActive.Height());
                MilliSleep(150000);
				if (chainActive.Tip()->GetBlockTime() + Params().TargetSpacing() > GetAdjustedTime()) { //not time for generate
                    ...
                    LogPrintf("Timeout in LadacoinMiner : Invalid time: %s over hight limit active block (%s), unable to create new block ! wait 5 min...\n", GetAdjustedTime(), chainActive.Height());
					//return;
				MilliSleep(300000);
				}
            }
		...
		//LogPrintf("Testing 0 in LadacoinMiner : Nowback: %s NowCent: %s\n", nNowBack, nNowCent);
			...
			if (((chainActive.Tip()->GetBlockTime() + Params().TargetSpacing() > GetAdjustedTime()) && ((chainActive.Tip()->GetBlockTime() + 1 + Params().TargetSpacing() - nNowBack) < GetAdjustedTime())) || ((chainActive.Tip()->GetBlockTime() + 1 + Params().TargetSpacing() - nNowBack) < GetAdjustedTime())) { //not time for generate
				...
				// Timeout after ~ 960 blocks
                    ...
                    if (nValue <= 0)
					{
				        ...
				        //return;
						LogPrintf("Warn in LadacoinMiner : Invalid zero amount on balance - unable for fast mining!\n");						
					...
					{   
						...
						if (nValue <= nSubsidyMin)
						{
							LogPrintf("Timeout in LadacoinMiner : Now time: %s over hight limit active block (%s), unable to create new block ! wait 1:45 min...\n", GetAdjustedTime(), chainActive.Height());
				            //return;
							LogPrintf("Warn in LadacoinMiner : Not minimum alowed amount on your balance - unable fast mining!\n");						
							LogPrintf("Warn in LadacoinMiner : Alowed balance: %s Your balance : %s It is unable fast mining!\n", FormatMoney(nSubsidyMin), FormatMoney(nValue));
						...
						{	
							...
							LogPrintf("Timeout in LadacoinMiner : Now time: %s over hight limit active block (%s), unable to create new block ! wait 1:35 min...\n", GetAdjustedTime(), chainActive.Height());
							//return;
							LogPrintf("LadacoinMiner : Alowed balance: %s Your balance > *2 : %s It is alowed fast mining and bonus 5 sec !\n", FormatMoney(nSubsidyMin), FormatMoney(nValue));
							MilliSleep(95000);
							}
							else
							{
				            ...
				            //return;
							LogPrintf("LadacoinMiner : Alowed balance: %s Your balance : %s It is alowed fast mining!\n", FormatMoney(nSubsidyMin), FormatMoney(nValue));
							MilliSleep(100000);
							}
						}
				...
				// Timeout after ~ 822 blocks
					...
					{   
						...
						{	
							...
							LogPrintf("Timeout in LadacoinMiner : Now time: %s over hight limit active block (%s), unable to create new block ! wait 1:38 min...\n", GetAdjustedTime(), chainActive.Height());
							//return;
							LogPrintf("LadacoinMiner : Alowed balance: %s Your balance > *2 : %s It is alowed fast mining and bonus 4 sec !\n", FormatMoney(nSubsidyMin), FormatMoney(nValue));
							MilliSleep(98000);
							}
							else
							{
					        LogPrintf("Timeout in LadacoinMiner : Now time: %s over hight limit active block (%s), unable to create new block ! wait 1:42 min...\n", GetAdjustedTime(), chainActive.Height());
				            //return;
							LogPrintf("LadacoinMiner : Alowed balance: %s Your balance : %s It is alowed fast mining!\n", FormatMoney(nSubsidyMin), FormatMoney(nValue));
							MilliSleep(102000);
							}
				...
				// Timeout after ~ 664 blocks
					...
					{   
						...
						{	
							...
							{
							LogPrintf("Timeout in LadacoinMiner : Now time: %s over hight limit active block (%s), unable to create new block ! wait 2:05 min...\n", GetAdjustedTime(), chainActive.Height());
				            //return;
							LogPrintf("LadacoinMiner : Alowed balance: %s Your balance : %s It is alowed fast mining!\n", FormatMoney(nSubsidyMin), FormatMoney(nValue));
							MilliSleep(125000);
							}
				...
				// Timeout after ~ 617 blocks
					...
					{   
						...
						{	
							...
							//return;
							LogPrintf("LadacoinMiner : Alowed balance: %s Your balance > *2 : %s It is alowed fast mining and bonus 2 sec !\n", FormatMoney(nSubsidyMin), FormatMoney(nValue));
							MilliSleep(136000);
							}
							else
							{
				...
				// Timeout after ~ 595 blocks
					...
					{   
						...
						{	
							...
							{
							LogPrintf("Timeout in LadacoinMiner : Now time: %s over hight limit active block (%s), unable to create new block ! wait 2:22 min...\n", GetAdjustedTime(), chainActive.Height());
				            //return;
							LogPrintf("LadacoinMiner : Alowed balance: %s Your balance : %s It is alowed fast mining!\n", FormatMoney(nSubsidyMin), FormatMoney(nValue));
							MilliSleep(142000);
							}
				...
				// Timeout already before
                    ...
                    if (nValue <= 0)
					{
						LogPrintf("Timeout in LadacoinMiner : Now time: %s over hight limit active block (%s), unable to create new block ! wait 2:35 min...\n", GetAdjustedTime(), chainActive.Height());
				        //return;
						LogPrintf("Warn in LadacoinMiner : Invalid zero amount on balance - unable for fast mining!\n");						
						//throw JSONRPCError(RPC_INVALID_PARAMETER, "Invalid zero amount on balance - unable for fast mining!");
						//return;
					...
					{   
						...
						{	
					        LogPrintf("Timeout in LadacoinMiner : Now time: %s over hight limit active block (%s), unable to create new block ! wait 2:30 min...\n", GetAdjustedTime(), chainActive.Height());
				            //return;
							LogPrintf("LadacoinMiner : Alowed balance: %s Your balance : %s It is alowed fast mining!\n", FormatMoney(nSubsidyMin), FormatMoney(nValue));
							MilliSleep(150000);
						}
				...
				//LogPrintf("Timeout in LadacoinMiner : Now time: %s over hight limit active block (%s), unable to create new block ! wait 2.5 min...\n", GetAdjustedTime(), chainActive.Height());
				//return;
				//MilliSleep(150000);					
				}
			}
			...
			if (chainActive.Height()+1 > nHeightMaxNext) {
                // Mark block as in flight already
                LogPrintf("Timeout in LadacoinMiner : Invalid time: %s over hight limit next block (%s), unable to create new block ! wait 5 min...\n", GetAdjustedTime(), chainActive.Height()+1);
				return;
				MilliSleep(300000);
			...
			if (chainActive.Height()+1 > nHeightMaxnTime) {
                ...
                // Mark block as in flight already
                LogPrintf("Timeout in LadacoinMiner : Invalid time: %s over hight limit in now Time for block (%s), unable to create new block ! wait 5 min...\n", GetAdjustedTime(), chainActive.Height());
				return;
				MilliSleep(300000);
            }
            ...
            if (!pblocktemplate.get())
            {
                LogPrintf("Error in LadacoinMiner: Keypool ran out, please call keypoolrefill before restarting the mining thread\n");
                return;
            }
            CBlock *pblock = &pblocktemplate->block;
            IncrementExtraNonce(pblock, pindexPrev, nExtraNonce);

            LogPrintf("Running LadacoinMiner with %u transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        LogPrintf("LadacoinMiner terminated\n");
        throw;
    }
    catch (const std::runtime_error &e)
    {
        LogPrintf("LadacoinMiner runtime error: %s\n", e.what());
        return;
    }
}
